    ...
    public static void gameInstance(){
        try{
            ...
            if(qtdnavios==0 || qtdnavios>n*m){
                ...
                boolean result;                                      //variável que recebe o resultado de um tiro (true para o caso de acerto de um navio e false para erro)
                ...
                while(pontos<qtdnavios){                             //condição para o fim do jogo
                    ...
                    if(nivel >= 1){                                  //durante a execução de uma partida, verifica o nível escolhido pelo usuário e executa as condições diferenciadas de jogo
                        if(jogadas>=(n*m)/1.6){
                            win = false;
                            break;
                        }
                        if(nivel == 2){
                            chooseShips(tabuleiro, pontos, n, m, qtdnavios);
                        }
                    }
                }
